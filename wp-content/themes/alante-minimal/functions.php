...
function alante_thinkup_child_frontscripts() {
	...
	wp_enqueue_style( 'alante-thinkup-style-minimal', get_stylesheet_directory_uri() . '/style.css', array( 'alante-thinkup-style' ), wp_get_theme()->get('Version') );
}
...
function alante_thinkup_updateoption_child_settings() {
	...
	$name_options_child   = $name_theme_lower . '_thinkup_child_settings_minimal';
	...
	if ( $options_child_settings != 1 ) {
		...
		$options_free['thinkup_styles_skin']       = 'minimal';
