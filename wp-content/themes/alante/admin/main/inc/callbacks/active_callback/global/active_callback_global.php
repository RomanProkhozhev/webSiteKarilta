...
function alante_thinkup_customizer_callback_active_global( $control ) {
	...
	$thinkup_homepage_outroactionlink  = $control->manager->get_setting($prefix_name . 'thinkup_redux_variables[thinkup_homepage_outroactionlink]')->value();
	...
	$thinkup_header_instagramswitch    = $control->manager->get_setting($prefix_name . 'thinkup_redux_variables[thinkup_header_instagramswitch]')->value();
	...
	// Homepage - Call To Action - Outro
	if ( $thinkup_homepage_outroactionlink == 'option1' and
			$control_id == 'thinkup_homepage_outroactionpage' ) {
		return true;
	} else if ( $thinkup_homepage_outroactionlink == 'option2' and
			$control_id == 'thinkup_homepage_outroactioncustom' ) {
		return true;
	}
