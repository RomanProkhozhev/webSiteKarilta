...
get_header(); ?>
			...
			<?php while ( have_posts() ) : the_post(); ?>
					...
					<header class="entry-header">
						<div class="entry-meta">
							<?php
								...
								printf( __( 'Published ', 'alante') . '<span><time datetime="%1$s">%2$s</time></span> ' . __( 'at', 'alante' ) . ' <a href="%3$s" title="' . esc_attr__( 'Link to full-size image', 'alante' ) . '">%4$s &times; %5$s</a> ' . __( 'in', 'alante' ) . ' <a href="%6$s" title="' . esc_attr__( 'Return to ', 'alante' ) . '%7$s" rel="gallery">%8$s</a>',
				...
				<?php alante_thinkup_input_imagesnav(); ?>
